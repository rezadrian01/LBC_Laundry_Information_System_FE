    ...
    return (
        <>
            {isWeightOrderInput && <div>
                ...
                <Input ref={ref} borderBottom id={id} name={name} unitLabel={unitLabel} type="number" inputMode="numeric" step="0.01" bgColor={null} {...props} />
            </div>}
            ...
            {isOrderSummary && !isDropdown && <div className='grid grid-cols-4 md:grid-cols-12 items-center gap-4 w-full'>
                ...
                <Input ref={ref} grid={true} padding="py-[.5px] px-2" id={id} name={name} textCenter={textCenter} {...props} />
            </div>}
