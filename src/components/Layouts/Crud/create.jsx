...
const CreateLayout = ({ title, isNew = true, keys = [], isItemList = false, numberTypeIndex = [], defaultValues = null, successCreateAlertTitle = "Data berhasil dibuat", successDeleteAlertTitle = "Data berhasil dihapus", contents = [] }) => {
